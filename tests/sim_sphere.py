...
# The histogram functions are used to calculate the correlation function
...
for t in range(0,n_steps):
    ...
    for i in range(0,N):
        ...
        for j in range(i+1,N):
            ...
            F_r[i,:]=F_r[i,:]+F_ij
            F_r[j,:]=F_r[j,:]+F_ji
            # histogram for correlation function
            if t >= t_stab:
...
#pickle.dump( [number_of_neighbors, number_of_new_neighbors, histogram/(n_steps-t_stab)], open( 'neighbors.p', "wb" ) )
