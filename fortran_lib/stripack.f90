...
!
  ...
  real ( kind = 8 ), intent(in), dimension(k) :: x
  real ( kind = 8 ), intent(in), dimension(k) :: y
  real ( kind = 8 ), intent(in), dimension(k) :: z
  integer ( kind = 4 ), intent(inout), dimension(k) :: lend
  integer ( kind = 4 ), intent(inout), dimension(*) :: list
  integer ( kind = 4 ), intent(inout) :: lnew
  integer ( kind = 4 ), intent(inout), dimension(*) :: lptr
  integer ( kind = 4 ), intent(out) :: ier
  !f2py intent(in,out) :: lend, list, lnew, lptr
  real ( kind = 8 ) b1
  real ( kind = 8 ) b2
  real ( kind = 8 ) b3
  integer ( kind = 4 ) i1
...
!
  ...
  integer ( kind = 4 ), intent(inout), dimension(*) :: lend
  integer ( kind = 4 ), intent(inout), dimension(*) :: list
  integer ( kind = 4 ), intent(inout), dimension(*) :: lptr
  integer ( kind = 4 ), intent(inout) :: lnew
  !f2py intent(in,out) :: lend, list, lnew, lptr
...
!
  ...
  integer ( kind = 4 ), intent(in), dimension(6*(n-2)) :: lptr
  integer ( kind = 4 ), intent(in), dimension(6*(n-2)) :: list
  integer ( kind = 4 ), intent(in), dimension(n) :: lend
  integer ( kind = 4 ), intent(inout) :: ltri(nrow,*)
  integer ( kind = 4 ), intent(out) :: nt
  integer ( kind = 4 ), intent(out) :: ier
  !f2py intent(in, out) :: ltri
  logical              arcs
  integer ( kind = 4 ) i
  integer ( kind = 4 ) i1
  integer ( kind = 4 ) i2
...
!
  ...
  integer ( kind = 4 ), intent(in) :: n
  integer ( kind = 4 ), intent(in) :: list(6*(n-2))
  integer ( kind = 4 ), intent(in) :: lptr(6*(n-2))
  integer ( kind = 4 ), intent(in) :: lend(n)
  integer ( kind = 4 ), intent(inout) :: ltri(3,*)
  integer ( kind = 4 ), intent(out) :: nt
  integer ( kind = 4 ), intent(out) :: ier
  !f2py intent(in,out) :: ltri
  integer ( kind = 4 ) i
...
!
  ...
  real ( kind = 8 ), intent(in), dimension(n) :: z
  integer ( kind = 4 ), intent(out), dimension(6*(n-2)) :: lptr
  integer ( kind = 4 ), intent(out), dimension(n) :: lend
  integer ( kind = 4 ), intent(out), dimension(6*(n-2)) :: list
  integer ( kind = 4 ), intent(out) :: lnew
  integer ( kind = 4 ), intent(inout), dimension(n) :: near
  integer ( kind = 4 ), intent(inout), dimension(n) :: next
  real ( kind = 8 ), intent(inout), dimension(n) :: dist
  integer ( kind = 4 ), intent(out) :: ier
!f2py intent(in,out) :: near, next, dist
  real ( kind = 8 ) d
  real ( kind = 8 ) d1
  real ( kind = 8 ) d2
  real ( kind = 8 ) d3
